...
const SUPABASE_URL = window.SUPABASE_URL || 'https://ilwortdtfoymttozhwvt.supabase.co';
const SUPABASE_ANON_KEY = window.SUPABASE_ANON_KEY || 'sb_publishable_K4xE4VaBi99mmnZ7AKvn2w_i4m1dSJp';
